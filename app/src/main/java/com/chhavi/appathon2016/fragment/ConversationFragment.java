...
import com.chhavi.appathon2016.adapter.OpponentsFromCallAdapter;
import com.chhavi.appathon2016.definitions.Constants;
import com.chhavi.appathon2016.holder.DataHolder;
import com.chhavi.appathon2016.util.CameraUtils;
import com.chhavi.appathon2016.view.RTCGLVideoView;
...
public class ConversationFragment extends Fragment implements Serializable, QBRTCClientVideoTracksCallbacks, QBRTCSessionConnectionCallbacks, CallActivity.QBRTCSessionUserCallback, OpponentsFromCallAdapter.OnAdapterEventListener {
    ...
    public static ConversationFragment newInstance(List<QBUser> opponents, String callerName,
        ...
        bundle.putInt(Constants.CONFERENCE_TYPE, qbConferenceType.getValue());
        bundle.putString(CALLER_NAME, callerName);
        bundle.putSerializable(Constants.OPPONENTS, (Serializable) opponents);
        if (userInfo != null) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            opponents = (ArrayList<QBUser>) getArguments().getSerializable(Constants.OPPONENTS);
            qbConferenceType = getArguments().getInt(Constants.CONFERENCE_TYPE);
    ...
    private void initViews(View view) {
        ...
        incUserName.setBackgroundResource(Current.selectBackgrounForOpponent((
